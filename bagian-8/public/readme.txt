...
Tipe ALIASES yaitu tipe alias, alias dimana suatu tipe data bisa dijadikan sebuah variabel untuk mempersingkat code

Type ALIASES berguna untuk
1. Meminimalisir code
2. Membuat code lebih mudah dibaca
3. Membuat code lebih mudah diubah
