mengenai bagian 10 yaitu THE DOM & TYPE CASTING
...
THE DOM = Biasanya digunakan untu memanipulasi, memodifikasi, meng-akses, dokument HTML atau XML

TYPE CASTING DALAM THE DOM
1. menghindari "null" menggunakan Non-Null Assertion "!" 
2. menggunakan "as" untuk mengetahui bagian apa yang akan di DOM


-- KESIMPULAN--
Type casting pada DOM di TypeScript membantu Anda bekerja dengan elemen
secara lebih aman dan eksplisit, 
memungkinkan akses ke properti dan 
metode spesifik dari elemen yang relevan. 
Gunakan type casting ketika diperlukan, 
tetapi berhati-hatilah dengan kemungkinan elemen null.


-- REFERENSI -- 
YOUTUBE : https://www.youtube.com/watch?v=hcuKd-Q_tP8&list=PL4cUxeGkcC9gUgr39Q_yD6v-bSyMwKPUI&index=11